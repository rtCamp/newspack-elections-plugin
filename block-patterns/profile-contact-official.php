<?php
/**
 * Title: Profile Contact Information (Official)
 * Slug: npe/profile-contact-official
 * Viewport Width: 250
 * Inserter: true
 */
?>
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			<!-- wp:npe/profile-row {"showLabel":false,"field":{"type":"text","key":"address_official"}} -->
				<!-- wp:npe/profile-field-text {"fontSize":"small","field":{"type":"text","key":"address_official"}} /-->
			<!-- /wp:npe/profile-row -->
			...
			<!-- wp:npe/profile-row {"showLabel":false,"field":{"type":"link","key":"website_official"}} -->
				<!-- wp:npe/profile-field-link {"linkTextOverride":"Official Website","fontSize":"small"} /-->
			<!-- /wp:npe/profile-row -->
			</div>
		<!-- /wp:group -->

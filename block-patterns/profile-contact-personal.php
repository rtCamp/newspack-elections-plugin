<?php
/**
 * Title: Profile Contact Information (Personal)
 * Slug: npe/profile-contact-personal
 * Viewport Width: 250
 * Inserter: true
 */
?>
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			<!-- wp:npe/profile-row {"showLabel":false,"field":{"type":"link","key":"website_personal"}} -->
				<!-- wp:npe/profile-field-link {"linkTextOverride":"Personal Website","fontSize":"small"} /-->
			<!-- /wp:npe/profile-row -->
			</div>
		<!-- /wp:group -->

...
namespace Govpack\Blocks\ProfileLink;
 ...
 */
class ProfileLink extends \Govpack\Blocks\Profile\Profile {

	public string $block_name = 'govpack/profile-link';
	...
	public function block_build_path(): string {
		return $this->plugin->build_path( 'blocks/ProfileLink' );
	}
